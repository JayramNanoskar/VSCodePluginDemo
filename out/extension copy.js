...
function activate(context) {
    ...
    function createLayout(data, totElem) {
    ...
    function writeToHTML(fileText, componentName) {
        debugger;
        let setting = vscode.Uri.parse("file:///" + "D:\\MY_ANGULAR_POC\\MY_APP\\src\\app\\app-main-content\\app-main-content.component.html");
    ...
    function updateTypeScriptFile(data, index, htmlString, col, componentName) {
        if (data[2]) {
    ...
    function generateCodeSnippet(data, index, htmlString, col) {
        debugger;
...
function addControls(htmlString, htmlControlsText, divIds) {
...
function getHtmlTextByType(data) {
...
function getDivIdBySequence(seq, col) {
    let num = Number(seq);
...
function modifyTSFile(componentName, content) {
    ...
    */
    debugger;
    let setting = vscode.Uri.parse("file:///" + "D:\\MY_ANGULAR_POC\\MY_APP\\src\\app\\app-main-content\\app-main-content.component.ts");
    vscode.workspace.openTextDocument(setting).then((a) => {
        if (!a.isClosed) {
            vscode.window.showTextDocument(a, 1, false).then(e => {
                e.edit(edit => {
                    ...
                    if (typeof matchText !== 'undefined' && matchText !== null) {
                        ...
                        var textRange = new vscode.Range(0, firstLine.range.start.character, e.document.lineCount - 1, lastLine.range.end.character);
